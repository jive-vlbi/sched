...
C
C     Modify a component of an active object.
C
      SUBROUTINE OBJMOD ( OBJ, COMP, VALUE, OBJLIS )
...
C
      ...
      CALL OBJCHK ( 'OBJMOD', OBJ, OBJLIS, OK )
      ...
      IF ( OBJ(2) .EQ. NULL ) THEN
         CALL CHKIN ( 'OBJMOD' )
         CALL SETMSG('You are attempting to modify the value of an '
     .   //          'inactive object.  You can only modify the '
