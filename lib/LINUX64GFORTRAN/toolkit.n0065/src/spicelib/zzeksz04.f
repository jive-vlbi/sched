C$Procedure ZZEKSZ04 ( EK, element entry size, class 4 )
 
      INTEGER FUNCTION ZZEKSZ04 ( HANDLE, SEGDSC, COLDSC, RECPTR )
 
C$ Abstract
C
C     Return the size of a specified entry in a class 4 column.
C
C$ Disclaimer
C
...
C
         CALL DASRDI ( HANDLE, DATPTR, DATPTR, ZZEKSZ04 )
