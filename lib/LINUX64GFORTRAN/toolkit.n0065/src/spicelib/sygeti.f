C$Procedure      SYGETI ( Return all components for a symbol )
 
      SUBROUTINE SYGETI ( NAME,
...
C     The calls,
C
C     CALL SYGETI ( 'pencils', TABSYM, TABPTR, TABVAL,
C    .               N,         VALUES, FOUND           )
C
C     CALL SYGETI ( 'pens',     TABSYM, TABPTR, TABVAL,
C    .               N,         VALUES, FOUND           )
C
C     CALL SYGETI ( 'desks',    TABSYM, TABPTR, TABVAL,
C    .               N,         VALUES, FOUND           )
C
C
...
C
      ELSE
         ...
         CALL MOVEI ( TABVAL(LOCVAL), N, VALUES )
