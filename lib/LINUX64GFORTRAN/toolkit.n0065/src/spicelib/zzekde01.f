C$Procedure      ZZEKDE01 ( EK, delete column entry, class 1 )
 
      SUBROUTINE ZZEKDE01 ( HANDLE, SEGDSC, COLDSC, RECPTR )
 
C$ Abstract
C
C     Delete a specified class 1 column entry from an EK record.
C
C$ Disclaimer
C
