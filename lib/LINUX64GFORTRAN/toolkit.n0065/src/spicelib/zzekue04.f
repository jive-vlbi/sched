C$Procedure      ZZEKUE04 ( EK, update column entry, class 4 )
 
      SUBROUTINE ZZEKUE04 (  HANDLE,  SEGDSC,  COLDSC,
     .                       RECPTR,  NVALS,   IVALS,  ISNULL  )
 
C$ Abstract
C
C     Update a specified class 4 column entry in an EK record.
C
C$ Disclaimer
C
