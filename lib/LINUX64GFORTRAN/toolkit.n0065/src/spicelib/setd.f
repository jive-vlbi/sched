C$Procedure            SETD ( Compare double precision sets )
 
      LOGICAL FUNCTION SETD ( A, OP, B )
 
C$ Abstract
C
C     Given a relational operator, compare two double precision sets.
C
C$ Disclaimer
C
...
C
C     Determine the value of SETD from the results.
C
      SETD = ( COND .EQ. 1 )
