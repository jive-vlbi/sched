...
C     M2         I   3x3 double prercision matrix.
C     MOUT       O   3x3 double precision matrix. MOUT is the product
C                    M1*M2.
C
C$ Detailed_Input
C
...
C
C        MOUT(I,J) = Summation from K=1 to 3 of  ( M1(I,K) * M2(K,J) )
C
C$ Examples
C
C     Let M1 = |  1.0D0  1.0D0  0.0D0 |
C              |                      |
C              | -1.0D0  1.0D0  0.0D0 |
C              |                      |
C              |  0.0D0  0.0D0  1.0D0 |
