C$Procedure      SYNTHI ( Return the Nth component of a symbol )
...
C$ Abstract
C
C     Return the Nth component of a particular symbol in an integer
C     symbol table.
C
C$ Disclaimer
C
...
C     The calls,
C
C     CALL SYNTHI ( 'pens',    2, TABSYM, TABPTR, TABVAL, VALUE,
C    .               FOUND                                       )
C
C     CALL SYNTHI ( 'pencils', 3, TABSYM, TABPTR, TABVAL, VALUE,
C    .               FOUND                                       )
C
C     CALL SYNTHI ( 'chairs',  1, TABPTR, TABVAL, TABVAL, VALUE,
C    .               FOUND                                       )
C
