C$Procedure      SOMTRU ( Some entries true? )
 
      LOGICAL FUNCTION SOMTRU ( LOGCLS, N )
...
C$ Examples
C
C     Suppose you needed to confirm that a character set
C     WORDS contained at least one of the words in the phrase
C
...
C$ Index_Entries
C
C     test whether some logicals in an array are true
C
C-&
