...
C      --------  ---  --------------------------------------------------
C      JYEAR       O   The number of seconds/julian year
C
C$ Detailed_Input
C
C     None.
...
C$ Detailed_Output
C
C     The function returns the number of seconds per julian
C     year.
C
C$ Parameters
C
...
C$ Particulars
C
C     The julian year is often used as a fundamental unit
C     of time when dealing with ephemeris data.  For this
...
C      Page 8. University Science Books, 20 Edgehill Road,
