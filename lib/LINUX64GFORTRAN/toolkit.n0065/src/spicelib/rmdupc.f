C$Procedure      RMDUPC ( Remove duplicates from a character array )
 
      SUBROUTINE RMDUPC ( NELT, ARRAY )
 
C$ Abstract
C
C      Remove duplicate elements from a character array.
C
C$ Disclaimer
C
...
C$ Index_Entries
C
C     remove duplicates from a character array
C
C-&
