C$Procedure      SDIFFI ( Symmetric difference of two integer sets )
 
      SUBROUTINE SDIFFI ( A, B, C )
 
C$ Abstract
C
C      Take the symmetric difference of two integer sets to form
C      a third set.
C
C$ Disclaimer
C
...
C$ Index_Entries
C
C     symmetric difference of two integer sets
C
C-&
