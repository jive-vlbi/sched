C$Procedure      REFCHG (Reference frame Change)
...
C
         CALL ROTGET ( FRAME(NODE), ET, ROT(1,1,NODE), RELTO, FOUND  )
...
C
            CALL ROTGET ( THIS,  ET, ROT2(1,1,PUT), RELTO, FOUND  )
...
C
            CALL ROTGET ( THIS,  ET, TMPROT, RELTO,  FOUND  )
