...
C$Procedure      CKOPN ( CK, open new file. )
      ...
      SUBROUTINE CKOPN ( NAME, IFNAME, NCOMCH, HANDLE )
...
C     --------  ---  --------------------------------------------------
C     NAME       I   The name of the CK file to be opened.
...
C$ Detailed_Output
C
C     HANDLE   The handle of the opened CK file. If an error occurs the
C              value of this variable will not represent a valid handle.
C
C$ Parameters
C
C      None.
