C$Procedure      TOUCHL ( Touch a variable )
 
      LOGICAL FUNCTION TOUCHL ( LOG )
 
C$ Abstract
C
C     Return the value of the input logical
C
C$ Disclaimer
C
...
C      LOG        I   any logical
C
C       The function returns the value of LOG.
C
C$ Detailed_Input
C
C     LOG         is any logical
C
C$ Detailed_Output
C
C     The function returns the input logical
C
C$ Parameters
C
C      None.
