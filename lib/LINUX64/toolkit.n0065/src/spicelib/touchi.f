C$Procedure      TOUCHI ( Touch a variable )
 
      INTEGER FUNCTION TOUCHI ( INT )
 
C$ Abstract
C
C     Return the value of the input integer
C
C$ Disclaimer
C
...
C      INT        I   any integer
C
C       The function returns the value of INT.
C
C$ Detailed_Input
C
C     INT         is any integer
C
C$ Detailed_Output
C
C     The function returns the input integer
C
C$ Parameters
C
C      None.
