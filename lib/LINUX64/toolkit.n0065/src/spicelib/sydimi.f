C$Procedure            SYDIMI ( Return the dimension of a symbol )
 
      INTEGER FUNCTION SYDIMI ( NAME, TABSYM, TABPTR, TABVAL )
 
C$ Abstract
C
C     Return the dimension of a particular symbol in an integer symbol
C     table. If the symbol is not found, the function returns the
C     value zero.
C
C$ Disclaimer
C
...
C     table.
C
C     NUMVAL = SYDIMI ( 'books',    TABSYM, TABPTR, TABVAL )
C     NUMVAL = SYDIMI ( 'pencils',  TABSYM, TABPTR, TABVAL )
C     NUMVAL = SYDIMI ( 'pens',     TABSYM, TABPTR, TABVAL )
C     NUMVAL = SYDIMI ( 'erasers',  TABSYM, TABPTR, TABVAL )
C     NUMVAL = SYDIMI ( 'tablets',  TABSYM, TABPTR, TABVAL )
C
C
C     ----SYMBOL----------NUMVAL------
C     | books        |       2       |
...
C     --------------------------------
C
C     Note that the dimension of "tablets" is zero. This is due to the
C     fact that "tablets" is not in the symbol table.
C
C$ Restrictions
C
C     None.
