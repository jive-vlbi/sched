...
C$Procedure  MAXAD  ( Maximum element of array, DP )
 
      SUBROUTINE MAXAD ( ARRAY, NDIM, MAXVAL, LOC )
 
C$ Abstract
C
C     Locate the maximum element of a DP array.
C
C$ Disclaimer
C
...
C
C         CALL MAXAD ( A, 6, MAXVAL, LOC )
C
C      the values of MAXVAL and LOC are 64.D0 and 4 respectively.
C
C$ Restrictions
C
C      None
...
C$ Index_Entries
C
C     maximum element of d.p. array
C
C-&
