...
C$Procedure  MAXAI  ( Maximum element of array, integer )
 
      SUBROUTINE MAXAI ( ARRAY, NDIM, MAXVAL, LOC )
 
C$ Abstract
C
C     Locate the maximum element of an integer array.
C
C$ Disclaimer
C
...
C
C         CALL MAXAI ( A, 6, MAXVAL, LOC )
C
C      the values of MAXVAL and LOC are 64 and 4 respectively.
C
C$ Restrictions
C
C      None
...
C$ Index_Entries
C
C     maximum element of integer array
C
C-&
