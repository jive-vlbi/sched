C$Procedure      INTERD ( Intersect two double precision sets )
 
      SUBROUTINE INTERD ( A, B, C )
 
C$ Abstract
C
C      Intersect two double precision sets to form a third set.
C
C$ Disclaimer
C
