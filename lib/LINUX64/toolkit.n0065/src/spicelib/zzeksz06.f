C$Procedure ZZEKSZ06 ( EK, element entry size, class 6 )
 
      INTEGER FUNCTION ZZEKSZ06 ( HANDLE, SEGDSC, COLDSC, RECPTR )
 
C$ Abstract
C
C     Return the size of a specified entry in a class 6 column.
C
C$ Disclaimer
C
...
C
         CALL ZZEKGEI ( HANDLE, DATPTR, ZZEKSZ06 )
