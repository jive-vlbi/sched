C$Procedure      SSIZEI ( Set the size of an integer cell )
 
      SUBROUTINE SSIZEI ( SIZE, CELL )
 
C$ Abstract
C
C      Set the size (maximum cardinality) of an integer cell.
C
C$ Disclaimer
C
...
C$ Index_Entries
C
C     set the size of an integer cell
C
C-&
