C$Procedure      TOUCHC ( Touch a variable )
 
      CHARACTER FUNCTION TOUCHC ( STRING )
 
C$ Abstract
C
C     Return the first character of a string
C
C$ Disclaimer
C
...
C
C       The function returns the first character of the string.
C
C$ Detailed_Input
C
...
C
C        VALUES(1)(1:1) = TOUCHC ( VALUES(1)(1:1) )
C
C        PTR = PTR + 1
C
C        IF ( PTR .GT. N ) THEN
