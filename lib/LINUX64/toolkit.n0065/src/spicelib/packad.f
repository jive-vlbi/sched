C$Procedure      PACKAD ( Pack a double precision array )
 
      SUBROUTINE PACKAD ( IN,
     .                    PACK,   NPACK,
     .                    MAXOUT, NOUT,   OUT )
 
C$ Abstract
C
C     Pack the contents of a double precision array. That is,
C     take a set of arbitrarily spaced elements from an input
C     array, and make them adjacent elements in an output array.
C
C$ Disclaimer
C
...
C                 input array that is to become the i'th element of the
C                 output array. 
C
C     NPACK       is the number of elements to be packed into the
C                 output array.
C
C     MAXOUT      is the maximum number of elements to be packed into
C                 the output array. If NPACK is larger than MAXOUT, the
C                 extra items are ignored.
C
C$ Detailed_Output
C
