C$Procedure     NICEIO_3 ( Nicely formatted output -- test version )
 
      SUBROUTINE NICEIO_3 ( STRING, UNIT, STYLE )
      IMPLICIT NONE
...
C     UNIT       I   Logical unit connected to output.
...
C
C     UNIT      is the logical unit to which the output will be
C               directed.
C
