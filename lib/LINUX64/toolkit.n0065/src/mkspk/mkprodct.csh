...
#
#      Updated to use only g77. Removed escape character from \setenv
...
#      from choices g77 and fort77.  g77 is given preference.
#
...
if ( $status == 0 ) then
   setenv F_COMPILER g77
   echo " "
   echo "      Using the g77 compiler."
else
   echo " "
   echo "      The FORTRAN compiler g77 is not in the current path:"
   echo " "
   echo $PATH
   echo " "
