...
C
      ...
      REAL VALS(NCAT, NSET)
      REAL VALS2(NCAT, 3), VALS4(NCAT, 6)
      REAL VALS3(12)
...
C
      ...
      CALL PGPAGE
      CALL PGBCHT(NCAT, 6, VALS2, LABS, VMIN, VMAX, 'GF', 0.7, -1)
...
C      LOGICAL PGNOTO
      ...
      CHARACTER L*1, NB*2
C     Fill-style and hatching angle for hatch styles
      INTEGER HFS(6)
      REAL HAN(6)
      DATA HFS/3,   3,    4,      1,   3,    4 /
      DATA HAN/0.0, 45.0, 45.0, 0.0, -45.0, 0.0 /
C
