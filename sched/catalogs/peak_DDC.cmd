...
!  This file is meant to be used when the RDBE with the DDC personality
!  is being used in the rest of the project.
...
setup = $SCHED/setups/ptd7mm.set     !  Setup to use for peakup with DDC
linename = 'PSiO431'
