C$Procedure      CLEARC ( Clear a character-string array )
 
      SUBROUTINE CLEARC ( NDIM, ARRAY )
 
C$ Abstract
C
C      Fill a character-string array with blank strings.
C
C$ Disclaimer
C
...
C                      set to blank.
C       ARRAY     O    Character-string array to be filled.
C
C$ Detailed_Input
C
...
C$ Detailed_Output
C
C      ARRAY      is the character string array which is to be filled
C                 with blank elements.
C
C$ Parameters
C
C      None.
