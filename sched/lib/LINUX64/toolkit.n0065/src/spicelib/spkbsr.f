...
C        point SPKLEF so that the pool is initialized only if the file
C        table is empty.
C
C-    SPICELIB Version 5.4.0, 13-JUN-2013 (BVS)
C
C        Increased FTSIZE (from 1000 to 5000).
C
C        Increased STSIZE (from 50000 to 100000).
C
C-    SPICELIB Version 5.3.0, 01-MAR-2011 (NJB)
C
C        Bug fix: 
C
C          In the SPKSFS 'MAKE ROOM' state, when the suspended activity
