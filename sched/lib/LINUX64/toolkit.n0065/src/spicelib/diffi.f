C$Procedure      DIFFI ( Difference of two integer sets )
 
      SUBROUTINE DIFFI ( A, B, C )
 
C$ Abstract
C
C      Take the difference of two integer sets to form a third set.
C
C$ Disclaimer
C
...
C$ Index_Entries
C
C     difference of two integer sets
C
C-&
