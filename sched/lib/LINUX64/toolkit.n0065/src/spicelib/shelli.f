C$Procedure      SHELLI ( Shell sort an integer array )
 
      SUBROUTINE SHELLI ( NDIM, ARRAY )
 
C$ Abstract
C
C      Sort an integer array using the Shell Sort algorithm.
C
C$ Disclaimer
C
...
C            66
C
C      Then after a call to SHELLI, the array would be ordered as
C      follows:
C
C           -77
C            33
