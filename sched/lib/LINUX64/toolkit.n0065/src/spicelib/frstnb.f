C$Procedure            FRSTNB ( First non-blank character )
 
      INTEGER FUNCTION FRSTNB ( STRING )
 
C$ Abstract
C
C      Return the index of the first non-blank character in
...
C      FRSTNB     O   Index of the first non-blank character in STRING.
C
C$ Detailed_Input
C
...
C$ Detailed_Output
C
C      FRSTNB      is the index if the first non-blank character
C                  in the input string. If there are no non-blank
C                  characters in the string, FRSTNB is zero.
C
C$ Parameters
C
C     None.
...
C$ Examples
C
C      The following examples illustrate the use of FRSTNB.
C
C            FRSTNB ( 'ABCDE'         )   = 1
C            FRSTNB ( 'AN EXAMPLE'    )   = 1
C            FRSTNB ( '   AN EXAMPLE' )   = 4
C            FRSTNB ( '             ' )   = 0
C
C$ Restrictions
C
