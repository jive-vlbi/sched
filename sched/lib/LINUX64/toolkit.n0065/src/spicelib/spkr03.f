C$Procedure      SPKR03 ( SPK, read record from segment, type 3 )
...
C
C     On not so close inspection, you will see that the implementation
C     of this routine is identical to SPKR02, which reads a type 2
C     (Chebyshev polynomials, position only) segment.
C
C$ Examples
C
