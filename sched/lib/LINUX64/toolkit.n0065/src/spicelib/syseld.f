C$Procedure      SYSELD ( Select a subset of the values of a symbol )
 
      SUBROUTINE SYSELD ( NAME,
     .                    BEGIN,
     .                    END,
...
C     symbol in a double precision symbol table.
C
C$ Disclaimer
C
...
C
C     Let the dimension of the array VALUES be 3.
C
C
...
C     -------------   -----    ---    ---------------------   -------
C     MEAN_ANOM         1       2         6.239996D0            TRUE
C                                         1.99096871D-7
C
C     BODY4_POLE_RA     1       3         3.17681D2
C                                         1.08D-1
C                                         0.0D0
C
C     BODY4_PRIME       1       3                              FALSE
C
C     MEAN_ANOM         2       1                              FALSE
C
C     ORBIT_ECC         1      -2                              FALSE
C
C     K                 1       5                              FALSE
C     ----------------------------------------------------------------
C
...
C
C        - In the 3rd example, the symbol 'BODY4_PRIME' is not in the
C          symbol table.
C
...
C
     ...
     .        .AND. BEGIN .LE. END ) THEN
            ...
            CALL MOVED ( TABVAL(LOCVAL+BEGIN-1), END-BEGIN+1, VALUES )
