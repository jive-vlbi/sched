C$Procedure SDIFFD ( Symmetric difference of two double precision sets )
 
      SUBROUTINE SDIFFD ( A, B, C )
 
C$ Abstract
C
C      Take the symmetric difference of two double precision sets
C      to form a third set.
C
C$ Disclaimer
C
...
C$ Exceptions
C
C     1) If the symmetric difference of the two sets causes an excess of
...
C$ Index_Entries
C
C     symmetric difference of two d.p. sets
C
C-&
