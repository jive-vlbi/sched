C$Procedure      ZZEKCNAM ( EK, get column name )
 
      SUBROUTINE ZZEKCNAM ( HANDLE, COLDSC, COLUMN )
 
C$ Abstract
C
C     Look up the name of a column, given the column's descriptor.
C
C$ Disclaimer
C
...
C                    access.
C
C     COLDSC         is the column descriptor of a column whose name is
C                    desired.
C
C$ Detailed_Output
C
C     COLNAM         is the name of the specified column.
C
C$ Parameters
C
C     None.
...
C     name of a specified column.  This is a frequently
