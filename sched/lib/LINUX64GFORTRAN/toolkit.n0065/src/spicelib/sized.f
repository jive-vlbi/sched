C$Procedure            SIZED ( Size of a double precision cell )
 
      INTEGER FUNCTION SIZED ( CELL )
 
C$ Abstract
C
C     Return the size (maximum cardinality) of a double precision
C     cell.
C
C$ Disclaimer
C
