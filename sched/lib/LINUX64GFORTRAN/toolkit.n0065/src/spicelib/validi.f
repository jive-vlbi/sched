C$Procedure      VALIDI ( Validate an integer set )
 
      SUBROUTINE VALIDI ( SIZE, N, A )
 
C$ Abstract
C
C      Create a valid set from an integer set array.
C
C$ Disclaimer
C
...
C      VALIDC, VALIDD, and VALIDI. In the following example,
C
