...
C$Procedure  MINAD  ( Minimum element of array, DP )
 
      SUBROUTINE MINAD ( ARRAY, NDIM, MINVAL, LOC )
 
C$ Abstract
C
C     Locate the minimum element of a DP array.
C
C$ Disclaimer
C
...
C
C         CALL MINAD ( A, 6, MINVAL, LOC )
C
C      the values of MINVAL and LOC are 2.D0 and 5 respectively.
C
C$ Restrictions
C
C      None
...
C$ Index_Entries
C
C     minimum element of d.p. array
C
C-&
