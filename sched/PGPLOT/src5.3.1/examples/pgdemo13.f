...
C-
      ...
      SUBROUTINE LIST
C-----------------------------------------------------------------------
C List IDs of open devices.
C-----------------------------------------------------------------------
      INTEGER NMAX
      PARAMETER (NMAX=10)
      INTEGER NOPEN, IDS(NMAX), I
      CALL PGQIDS(NMAX, NOPEN, IDS)
      WRITE (*,*)                 'Number of open devices: ', NOPEN
      IF (NOPEN.GT.0) WRITE (*,*) 'Device identifiers:     ',
     :     (IDS(I),I=1,MIN(NMAX,NOPEN))
      END
