      SUBROUTINE PN3DB( ISCN, PTADD, TSTOP )
C
...
C
     ...
     1   'A, I3, A, F7.2, A )' )
     2   'qual=', 12+QL, ' azcolim=', DOAZ-PTOFF(LS), 
     3          ' dur=', PTDUR, 's  !NEXT!',
     4   'qual=', 10+QL, ' azcolim=', DOAZ,
     5          ' dur=', PTDUR, 's  !NEXT!',
     6   'qual=', 11+QL, ' azcolim=', DOAZ-PTINCR(LS),
     7          ' dur=', TRKDUR, 's  !NEXT!',
     8   'qual=', 22+QL, ' azcolim=', DOAZ-PTOFF(LS), 
     9          ' dur=', PTDUR, 's  !NEXT!',
     1   'qual=', 20+QL, ' azcolim=', DOAZ,           
     2          ' dur=', PTDUR, 's  !NEXT!',
     3   'qual=', 23+QL, ' elcolim=', DOEL+PTINCR(LS),
     4          ' dur=0   !NEXT!'
C
      RETURN
      END
