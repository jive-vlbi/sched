...
void cpgarc(float xcent, float ycent, float radius, float angl1, float angl2);
...
void cpgiden(void);
void cpgimab(const float *a, int idim, int jdim, int i1, int i2, int j1, int j2, float a1, float a2, const float *tr, float bval, int bi);
...
void cpgpie(float xcent, float ycent, float radius, float angl1, float angl2);
...
void cpgqid(int *id);
void cpgqids(int nmax, int *nopen, int *list);
...
void cpgsfs(int fs);
void cpgshd1(int n, const float *x, const float *y, float base);
void cpgshd2(int n, const float *x, const float *y1, const float *y2);
