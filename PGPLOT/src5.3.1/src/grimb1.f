C*GRIMB1 -- image of a 2D data array (image-primitive devices)
C+
      SUBROUTINE GRIMB1 (A, IDIM, JDIM, I1, I2, J1, J2,
     1                   A1, A2, PA, MININD, MAXIND, MODE, BVAL, BI)
      INTEGER IDIM, JDIM, I1, I2, J1, J2, MININD, MAXIND, MODE, BI
      REAL    A(IDIM,JDIM), A1, A2, PA(6), BVAL
C
C (This routine is called by GRIMB0.)
C--
      ...
      DO 20 J = J1,J2
          DO 10 I = I1,I2
              ...
              ELSE
                 ...
                 END IF
                 IF (MODE.EQ.0) THEN
                    IV = NINT((MININD*(A2-AV) + MAXIND*(AV-A1))/
     :                        (A2-A1))
