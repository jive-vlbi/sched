...
C some devices and by GRPCKG software for the other devices. Ten
...
C       the current device (in range 1-10).
C--
C  9-Feb-1983 - [TJP].
...
C  9-Dec-1998 - add more patterns from Pierre Somlyo [TJP].
C-----------------------------------------------------------------------
      INCLUDE 'grpckg1.inc'
      INTEGER NPAT
      PARAMETER (NPAT=10)
...
C
     ...
     5             10.0,  6.0, 10.0,  6.0,  1.0,  6.0, 1.0,  6.0,
     6             20.0,  0.0, 10.0,  6.0,  6.0,  6.0, 0.0,  0.0,
     7             16.0, 12.0,  4.0, 12.0, 16.0, 12.0, 4.0, 12.0,
     8             10.0,  6.0,  3.0,  6.0, 10.0,  6.0, 5.0,  6.0,
     9             20.0,  0.0, 20.0,  6.0,  1.0,  6.0, 1.0,  6.0/
C
      IF (GRCIDE.LT.1) THEN
