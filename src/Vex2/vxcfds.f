      LOGICAL FUNCTION VXCFDS( ISET, JSET )
C     Routine specific for the VEX2 extension of SCHED.
C     returns true if DS block in 2 SCHED sets are identical
...
C     Note: this class is the same as vxcftr.f since it was created as 
...
C
      IDENT = .TRUE.      
C
C     DATASTREAM dependendence on SUBPASS section trivial based on 
C     TRACKS
C
