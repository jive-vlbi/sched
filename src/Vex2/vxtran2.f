      SUBROUTINE VXTRAN2 ( TRANLEN, ISCN, ISTA, GAPERR )
C
...
C ----------------------------------------------------------------------
C
      IF (DEBUG) CALL WLOG( 1,'VXTRAN2: Check transfer time for ftp'//
     1          ' scans')
      GAPERR = .FALSE.
C
...
C
     ...
     1      'VXTRAN2: You have scheduled an ftp (GRABTO) scan but you ',
