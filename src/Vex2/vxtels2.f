      SUBROUTINE VXTELS2( BLOCK, NXXVEX, STAXX, XXLINK )
C
...
C
      INTEGER ISTA, JSTA
      LOGICAL NEWFND, VXCFDA2, VXCFSI2, VXCFAN2
C ----------------------------------------------------------------------
C
      WRITE( MSGTXT, '( A, A, A )' ) 
     1    'VXTELS2: Start sorting ', BLOCK, ' definition'
...
C
     ...
     1                 'VXTELS2: Number of '//BLOCK//' defs '//
