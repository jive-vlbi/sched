      SUBROUTINE VXTRAFQ2(ISCN, NMODE, OMODE, KFQ)
C
...
C
      ...
      INCLUDE 'vxlink2.inc'
C
      LOGICAL VXCFFQ2, FOUND
      INTEGER NMODE, OMODE, ISCN, JSCN, IFQ, KFQ
C
      CHARACTER VXNMFQ2*32
C
...
C
     ...
     1          'VXTRAFQ2: Number of $FQ defs exceeding MAXMOD,'//
     2          '  array size...')
C
...
C
            FQLINK(NFQVEX) = VXNMFQ2( NFQVEX, .TRUE. )
            CALL VXUNQL2( NFQVEX, FQLINK )
         END IF
C     
