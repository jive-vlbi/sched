      CHARACTER*32 FUNCTION VXNMRL2( IXX )
C
...
C        
      VXNMRL2 = 'RandomScramble' 
      IF( ROLLBY .EQ. 16) VXNMRL2 = 'StndRoll/16'
      IF( ROLLBY .EQ. 8) VXNMRL2 = 'StndRoll/8'
      IF( ROLLBY .EQ. 0) VXNMRL2 = 'NoRoll'
C
      RETURN
      END
