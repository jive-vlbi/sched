      SUBROUTINE VXSCHK2( ISCN, TAPOFF, WARNFS, WARNTS, WARNTSOF, 
...
C
     ...
     .    CALL WLOG( 1,'VXSCHK2:  Checking VEX tapes ')
C
...
C        
     ...
     1          * 86400d0) .LT. 15 ) THEN
               CALL PRTSCN( ISCN, 'VXSCHK2' )
               WRITE( MSGTXT, '( A, A, A )' ) 
     1             'VXSCHK2:  WARNING: Scan length < 15s',
...
C           
               CALL PRTSCN( ISCN, 'VXSCHK2' )
               WRITE( MSGTXT, '( A, A, A )' ) 
     1             'VXSCHK2:  WARNING: Tape early start failed ',
...
C
               CALL PRTSCN( ISCN, 'VXSCHK2' )
               WRITE( MSGTXT, '( A, A, A )' ) 
     1             'VXSCHK2:  WARNING: Mode setup <= 40s for ',
