...
C
C     I'm not sure what's going on with this routine.  It is not 
C     checked into SVN and it is not called from anywhere.  Perhaps
C     it should have been deleted after changes elsewhere.
C     Keep for now, but some day do something about it.  Oct. 15, 2008 RCW
C
